...
def get_model_from_config(model_config: Dict, dataset, task_type, save_dir,
    ...
    return get_model(
        ...
        epochs=model_config.get("epochs") or 50,
        ...
        const_lr=model_config.get("const_lr") or False,
        weight_decay=model_config.get("weight_decay") or 0.0,
        cbp=model_config.get("cbp") or False,
        replacement_rate=model_config.get("replacement_rate") or 0.00001,
        maturity_threshold=model_config.get("maturity_threshold") or 100,
        reinit_weights=model_config.get("reinit_weights") or 'xavier',
        decay_rate=model_config.get("decay_rate") or 0.99,
        ...
        n_embd=model_config.get("n_embd") or 768,
        d_dropout=model_config.get("d_dropout") or 0.1,
        num_feats=model_config.get("num_feats") or 32,
        n_jobs=n_jobs,
        seed=seed,
        logger=logger
    )
