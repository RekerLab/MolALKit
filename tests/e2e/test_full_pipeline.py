...
REGRESSION_SCENARIOS = [
    ...
    {
        "id": "gp_regression_with_loo_forget",
        "description": "Gaussian Process regression with LOO-based forgetting",
        "data_public": "freesolv",
        "model_config": "GaussianProcessRegressionPosteriorUncertainty_RBFKernelRDKitNorm_Config",
        "select_method": "explorative",
        "forget_method": "min_loo_error",
        "split_type": "random",
    },
    {
        "id": "svm_regression",
...
ADVANCED_SCENARIOS = [
    ...
    {
        "id": "no_validation_set",
        "description": "Full active learning set (no validation)",
        "data_public": "dili",
        "model_config": "RandomForest_RDKitNorm_Config",
        "select_method": "random",
        "forget_method": None,
